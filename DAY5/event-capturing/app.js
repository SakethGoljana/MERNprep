...
<p>${recipes[i].tags.join("_")}</p>
<button onclick="recipecart(event)">ADD</button>
...
const handleRootClick = (e) => {
  console.log("Root clicked:", e);
};

//Event Bubbling: The event starts from the clicked element and bubbles up to its parents.

// Event Capturing: The event starts from the top parent and goes down to the clicked element.

const btn = document.getElementById("btn");
btn.addEventListener("click", handleBtnClick);

parent.addEventListener("click", handleCardClick, true); // true for capturing phase
