...
if (data && Array.isArray(data.recipes)) {
  const italianRecipes = data.recipes.filter(
    (recipe) => recipe.cuisine === "Italian"
  );
  console.log(italianRecipes);
} else {
  console.error("data.recipes is undefined or not an array.");
}
